  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <Link href="/programs" className="text-sm font-medium text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors">Marketplace</Link>
              <Link href="/how-it-works" className="text-sm font-medium text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors">How It Works</Link>
              <Link href="/for-advertisers" className="text-sm font-medium text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors">For Advertisers</Link>
              <Link href="/for-partners" className="text-sm font-medium text-[var(--foreground-muted)] hover:text-[var(--foreground)] transition-colors">For Partners</Link>
            </nav>
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="absolute top-40 right-1/4 w-96 h-96 bg-[var(--secondary)]/10 rounded-full blur-3xl" />
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden border border-[var(--border)] shadow-2xl shadow-[var(--primary)]/10">
              <div className="bg-gradient-to-br from-[var(--sidebar-bg)] to-[var(--foreground)] p-8">
      ...
      <section ref={statsRef} className="py-20 bg-[var(--sidebar-bg)] relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-1/4 w-64 h-64 bg-[var(--primary)] rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-[var(--secondary)] rounded-full blur-3xl" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                <div className="inline-flex items-center justify-center w-36 h-36 rounded-2xl bg-white/10 backdrop-blur mb-4">
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -4 }}
                className="group relative p-6 rounded-2xl border border-[var(--border)] bg-[var(--card)] hover:shadow-xl hover:border-[var(--primary-200)] transition-all duration-300"
              >
                <div
            ...
            <div className="relative p-12 md:p-16 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/login">
                  <Button
                    size="lg"
                    className="bg-white text-[var(--primary)] hover:bg-white/90 gap-2 h-12 px-8"
                  >
                    Get Started Free
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/60 text-sm">Customer Acquisition Operating System</p>
            </div>
